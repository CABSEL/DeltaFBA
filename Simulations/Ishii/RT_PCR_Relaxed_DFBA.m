...
for j = 2:numel(conditions)
    ...
    P_D(:,j-1) = Predicted;
    R_D(:,j-1) = RxnExpr_mod;
    save(strcat('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_Relaxed_DFBA\MAT_Files\', conditions{1,j},'.mat'))
    
end

xlswrite('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_Relaxed_DFBA\Results.xlsx',M_D,1);
xlswrite('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_Relaxed_DFBA\Results.xlsx',P_D,2);
xlswrite('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_Relaxed_DFBA\Results.xlsx',R_D,3);
xlswrite('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_Relaxed_DFBA\Results.xlsx',Cor,4);
xlswrite('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_Relaxed_DFBA\Results.xlsx',intCor,5);
xlswrite('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_Relaxed_DFBA\Results.xlsx',NRMSE,6);
xlswrite('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_Relaxed_DFBA\Results.xlsx',upRecall,7);
xlswrite('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_Relaxed_DFBA\Results.xlsx',downRecall,8);
xlswrite('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_Relaxed_DFBA\Results.xlsx',Sol_stat,9);
xlswrite('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_Relaxed_DFBA\Results.xlsx',Sol_stat2,10);