...
load('D:\GitHub\D_FBA\REMI\remi\models\iJO1366.mat') % this model is taken from BiGG database
load('D:\GitHub\D_FBA\REMI\remi\data\test_expr.mat') % Data is used from this: E-Flux2 and SPOT: Validated Methods for Inferring Intracellular Metabolic Flux Distributions from Transcriptomic Data
genes=expr{1};
genes_data=expr{2};
...
for mutiter = 1:numel(expr_cols)-1
    ...
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\Array_REMI/',expr_cols{1,mut}, '.xlsx'),M_Wt,1);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\Array_REMI/',expr_cols{1,mut}, '.xlsx'),M_Exp,2);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\Array_REMI/',expr_cols{1,mut}, '.xlsx'),P_Wt,3);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\Array_REMI/',expr_cols{1,mut}, '.xlsx'),P_Exp,4);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\Array_REMI/',expr_cols{1,mut}, '.xlsx'),R_D,5);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\Array_REMI/',expr_cols{1,mut}, '.xlsx'),Wt_Full,6);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\Array_REMI/',expr_cols{1,mut}, '.xlsx'),Exp_Full,7);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\Array_REMI/',expr_cols{1,mut}, '.xlsx'),R_full,8);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\Array_REMI/',expr_cols{1,mut}, '.xlsx'),sol_pfba,9);
