...
for mutiter = 1:numel(expr_cols)-1
    ...
    tarns_cut=0.00001; % transcript cutoff
    up=0.99; % this cutoff indicates 5% of all reaction
    down=0.99;
    ...
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_REMI/',expr_cols{1,mut}, '.xlsx'),M_Wt,1);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_REMI/',expr_cols{1,mut}, '.xlsx'),M_Exp,2);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_REMI/',expr_cols{1,mut}, '.xlsx'),P_Wt,3);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_REMI/',expr_cols{1,mut}, '.xlsx'),P_Exp,4);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_REMI/',expr_cols{1,mut}, '.xlsx'),R_D,5);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_REMI/',expr_cols{1,mut}, '.xlsx'),Wt_Full,6);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_REMI/',expr_cols{1,mut}, '.xlsx'),Exp_Full,7);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_REMI/',expr_cols{1,mut}, '.xlsx'),R_full,8);
    xlswrite(strcat('D:\GitHub\D_FBA\Simulations\Ishii\RT_PCR_REMI/',expr_cols{1,mut}, '.xlsx'),sol_pfba,9);
