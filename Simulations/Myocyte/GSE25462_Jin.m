...
[num,txt,~] = xlsread('Data\Myocytes\GSE25462_DE.xlsx');
genes = txt(2:end,9);
genes_data = num(:,5);
...
xlswrite(strcat(root,'\Simulations\Myocyte\Results_5_2_GSE25462.xlsx'),P_D,1);
xlswrite(strcat(root,'\Simulations\Myocyte\Results_5_2_GSE25462.xlsx'),R_D,2);
xlswrite(strcat(root,'\Simulations\Myocyte\Results_5_1_GSE25462.xlsx'),P_D2,1);
xlswrite(strcat(root,'\Simulations\Myocyte\Results_5_1_GSE25462.xlsx'),R_D,2);
save(strcat(root,'\Simulations\Myocyte\GSE25462_5.mat'));
...
xlswrite(strcat(root,'\Simulations\Myocyte\Results_25_1_GSE25462.xlsx'),P_D2,1);
xlswrite(strcat(root,'\Simulations\Myocyte\Results_25_1_GSE25462.xlsx'),R_D,2);
save(strcat(root,'\Simulations\Myocyte\GSE25462_25.mat'));