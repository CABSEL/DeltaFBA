...
[num,txt,~] = xlsread('Data\Myocytes\GSE19420_DE.xlsx');
genes = txt(2:end,9);
genes_data = num(:,5);
...
xlswrite(strcat(root,'\Simulations\Myocyte\Results_5_2_GSE19420.xlsx'),P_D,1);
xlswrite(strcat(root,'\Simulations\Myocyte\Results_5_2_GSE19420.xlsx'),R_D,2);
xlswrite(strcat(root,'\Simulations\Myocyte\Results_5_1_GSE19420.xlsx'),P_D2,1);
xlswrite(strcat(root,'\Simulations\Myocyte\Results_5_1_GSE19420.xlsx'),R_D,2);
save(strcat(root,'\Simulations\Myocyte\GSE19420_5.mat'));
...
xlswrite(strcat(root,'\Simulations\Myocyte\Results_25_1_GSE19420.xlsx'),P_D2,1);
xlswrite(strcat(root,'\Simulations\Myocyte\Results_25_1_GSE19420.xlsx'),R_D,2);
save(strcat(root,'\Simulations\Myocyte\GSE19420_25.mat'));